class Renderer {
    constructor(numberOfButtonsToFitWindowWidth, textResizeFactor) {
        ...
        this.numberOfAllButtons = 6;
        this.buttonWidthFactor = 0.8;
        this.buttonHeightFactor = 0.4;
        this.buttonFontSizeFactor = 1 / 7;
...
class LandscapeRenderer extends Renderer {
    constructor(textResizeFactor) {
        super(9, textResizeFactor);
...
class PortraitRenderer extends Renderer {
    constructor(numberOfButtonsToFitWindowWidth, textResizeFactor) {
        super(numberOfButtonsToFitWindowWidth, textResizeFactor);
...
function render() {
    ...
    var numberOfButtonsToFitWindowWidth = isAndroid ? 3 : 6;

    var renderer;
    if (landscape) {
        renderer = new LandscapeRenderer(textResizeFactor);
    } else {
        renderer = new PortraitRenderer(numberOfButtonsToFitWindowWidth, textResizeFactor);
    }
    renderer.render();
}
